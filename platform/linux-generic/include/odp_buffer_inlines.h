...
{
/* ODP ThunderX buffer/buffer_hdr one-one mapping */
#ifdef HAVE_THUNDERX
...
/*
 * ODP ThunderX provides it's own buffer implementation
...
{
#ifdef HAVE_THUNDERX
	/* TODO: check if we really need to separate event_type field */
